...
export default {
  ...
  methods: {
    ...
    removeFromCart (cartProduct, cartIndex) {
      this.remove(cartProduct, cartIndex)
    },
    ...mapMutations([
        'remove'
    ])
