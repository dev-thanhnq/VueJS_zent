    ...
    <div class="paginationWrap">
      ...
      <div>
        <button class="paginationButton" @click="goPrePage" :class="{isButtonDisabled: isGoPrePageDisabled}">
          <img src="https://image.shutterstock.com/image-vector/sign-interface-icons-vector-design-600w-1391671907.jpg" alt="">
        </button>
        <button class="paginationButton" @click="goNextPage" :class="{isButtonDisabled: isGoNextPageDisabled}">
          <img src="https://image.shutterstock.com/image-vector/right-arrow-button-icon-vector-600w-1171085566.jpg" alt="">
        </button>
      </div>
    </div>
  </div>
